...
/**
 * Decide which details page to send user back to:
 * - Admins (logged in) → event_details.php
 * - Students (no session) → student_event_details.php
 */
$detailsPage = isset($_SESSION['user']) ? 'event_details.php' : 'student_event_details.php';
